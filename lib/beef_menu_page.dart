...
class BeefMenuPage extends StatefulWidget {
  @override
  _BeefMenuPageState createState() => _BeefMenuPageState();
}

class _BeefMenuPageState extends State<BeefMenuPage> {
  ...
  Future<void> fetchMeals() async {
    final data = await service.getMeals('beef');
    setState(() {
      meals = data ?? [];
      isLoading = false;
    });
